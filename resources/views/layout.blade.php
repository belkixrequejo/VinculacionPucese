...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('app.dashboard') }}" class="logo">
      ...
      <span class="logo-mini"><b>PUCE-</b>Esmeraldas</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PUCE-</b>Esmeraldas</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-calendar-plus-o"></i> <span>Rols</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('app.rols.page') }}">Configuración</a></li>
            <li><a href="{{ route('app.rols.page') }}">Rangos</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">Belkix</a>.</strong> PUCE-Esmeraldas.
  </footer>
