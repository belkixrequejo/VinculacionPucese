...
|
*/
Route::get('descargar-student', 'StudentController@excel')->name('student.excel');
...
//ROL
Route::get('rols','RolsController@showPage')->name('app.rols.page');
Route::get('rols/listar','RolsController@listAll')->name('app.rols.list');
Route::post('rols/insertar','RolsController@save')->name('app.rols.save');
Route::post('rols/sesion','RolsController@setSession')->name('app.rols.sesion');
Route::post('rols/eliminar','RolsController@delete')->name('app.rols.delete');
...
//excel descargar
//excel
Route::get('descargar','ExcelController@excel')
